package osv.model.content.achievement_diary.falador;
...
public enum FaladorDiaryEntry {
	//Easy
	TELEPORT_ESSENCE_FAL("Have the wizard teleport you to the essence mine"),
	...
	//Hard
	PICK_POSION_BERRY("Pick poison berries: %totalstage", 10),
	STEAL_GEM_FAL("Steal gems from the gem stall: %totalstage", 84),
	KILL_GIANT_MOLE("Kill giant moles on task: %totalstage", 45),
	MINE_MITHRIL("Mine mithril ore: %totalstage", 84),
	
	//Elite
	HARVEST_TORSTOL("Harvest torstols: %totalstage", 150),
	FISH_MANTA("Fish manta rays: %totalstage", 350),
	MINE_GEM_FAL("Mine some gems within the crafting guild: %totalstage", 250);
