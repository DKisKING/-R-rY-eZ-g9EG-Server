package osv.model.content.achievement_diary.wilderness;

import static osv.model.content.achievement_diary.wilderness.WildernessDiaryEntry.*;

import java.util.EnumSet;
import java.util.Set;

import osv.model.content.achievement_diary.StatefulAchievementDiary;
import osv.model.players.Player;

public final class WildernessAchievementDiary extends StatefulAchievementDiary<WildernessDiaryEntry>{
	
	public static final Set<WildernessDiaryEntry> EASY_TASKS = EnumSet.of(LOW_ALCH, WILDERNESS_LEVER, WILDERNESS_ALTAR, KILL_EARTH_WARRIOR, KBD_LAIR, MINE_IRON_WILD, ABYSS_TELEPORT);
	
	public static final Set<WildernessDiaryEntry> MEDIUM_TASKS = EnumSet.of(MINE_MITHRIL_WILD, WILDERNESS_GODWARS, KILL_GREEN_DRAGON, MYSTERIOUS_EMBLEM, SMITH_MITHRIL_AXE, WILDERNESS_AGILITY);
	
	public static final Set<WildernessDiaryEntry> HARD_TASKS = EnumSet.of(CLAWS_OF_GUTHIX, SMITH_ADAMANT_SCIMITAR, CHAOS_ELEMENTAL, CRAZY_ARCHAEOLOGIST, CHAOS_FANATIC, SCORPIA, KARAMBWAN);
	
	public static final Set<WildernessDiaryEntry> ELITE_TASKS = EnumSet.of(CALLISTO, VENENATIS, VETION, DARK_CRAB, SMITH_RUNE_SCIM_WILD, MAGIC_LOG_WILD);
