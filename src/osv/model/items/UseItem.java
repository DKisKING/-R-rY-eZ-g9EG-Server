...
//		}          
		...
		case 987:
            ...
            case 1413:
            case 9705:
                if (itemUsed == 4207 && useWith == 1413) {
                    c.getItems().deleteItem2(4207, 1);
                    c.getItems().deleteItem2(1413, 1);
                    c.getItems().addItem(13091, 1);
                    c.getDH().sendItemStatement("You successfully crafted a \\nCrystal Halberd Full.", 13091);
                }
                else if (itemUsed == 4207 && useWith == 9705){
                    c.getItems().deleteItem2(4207, 1);
                    c.getItems().deleteItem2(9705, 1);
