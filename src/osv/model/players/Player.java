...
import osv.event.impl.IronmanRevertEvent;
import osv.event.impl.MinigamePlayersEvent;
import osv.event.impl.RunEnergyEvent;
import osv.event.impl.SkeletalMysticEvent;
import osv.event.impl.SkillRestorationEvent;
import osv.model.content.ChargeTrident;
import osv.model.content.GemBag;
import osv.model.content.HerbSack;
import osv.model.content.MysteryBox;
import osv.model.content.RandomEventInterface;
import osv.model.content.RunePouch;
import osv.model.content.SkillcapePerks;
import osv.model.content.Tutorial;
import osv.model.content.Tutorial.Stage;
import osv.model.content.Wogw;
import osv.model.content.LootingBag.LootingBag;
import osv.model.content.achievement.AchievementHandler;
import osv.model.content.achievement.Achievements;
import osv.model.content.achievement_diary.AchievementDiary;
import osv.model.content.achievement_diary.AchievementDiaryManager;
import osv.model.content.achievement_diary.RechargeItems;
import osv.model.content.barrows.Barrows;
import osv.model.content.barrows.TunnelEvent;
import osv.model.content.godwars.God;
import osv.model.content.godwars.Godwars;
...
import osv.model.content.presets.Presets;
import osv.model.content.safebox.SafeBox;
import osv.model.content.staff.PunishmentPanel;
import osv.model.content.teleportation.TeleportationInterface.TeleportData;
import osv.model.content.teleportation.TeleportationInterface.TeleportType;
import osv.model.content.titles.Titles;
import osv.model.content.trails.TreasureTrails;
import osv.model.entity.Entity;
import osv.model.entity.HealthStatus;
import osv.model.holiday.HolidayStages;
import osv.model.holiday.christmas.ChristmasPresent;
...
import osv.model.items.bank.Bank;
import osv.model.items.bank.BankPin;
import osv.model.minigames.bounty_hunter.BountyHunter;
import osv.model.minigames.fight_cave.FightCave;
import osv.model.minigames.lighthouse.DagannothMother;
import osv.model.minigames.pest_control.PestControl;
import osv.model.minigames.pest_control.PestControlRewards;
import osv.model.minigames.rfd.RecipeForDisaster;
import osv.model.minigames.warriors_guild.WarriorsGuild;
import osv.model.multiplayer_session.MultiplayerSessionStage;
import osv.model.multiplayer_session.MultiplayerSessionType;
import osv.model.multiplayer_session.duel.Duel;
import osv.model.multiplayer_session.duel.DuelSession;
import osv.model.multiplayer_session.trade.Trade;
import osv.model.npcs.NPC;
import osv.model.npcs.NPCDeathTracker;
import osv.model.npcs.NPCHandler;
import osv.model.npcs.bosses.DemonicGorilla;
import osv.model.npcs.bosses.KalphiteQueen;
import osv.model.npcs.bosses.cerberus.Cerberus;
import osv.model.npcs.bosses.cerberus.CerberusLostItems;
import osv.model.npcs.bosses.zulrah.ZulrahLostItems;
import osv.model.npcs.pets.PetHandler;
import osv.model.npcs.pets.PetHandler.Pets;
import osv.model.npcs.bosses.zulrah.Zulrah;
import osv.model.players.combat.CombatAssistant;
import osv.model.players.combat.DamageQueueEvent;
import osv.model.players.combat.Degrade;
import osv.model.players.combat.Hitmark;
import osv.model.players.combat.magic.MagicData;
import osv.model.players.combat.melee.QuickPrayers;
import osv.model.players.mode.Mode;
import osv.model.players.mode.ModeType;
import osv.model.players.skills.Agility;
import osv.model.players.skills.Cooking;
import osv.model.players.skills.SkillInterfaces;
import osv.model.players.skills.Skilling;
import osv.model.players.skills.Smelting;
import osv.model.players.skills.Smithing;
import osv.model.players.skills.SmithingInterface;
import osv.model.players.skills.agility.AgilityHandler;
import osv.model.players.skills.agility.impl.BarbarianAgility;
import osv.model.players.skills.agility.impl.GnomeAgility;
import osv.model.players.skills.agility.impl.Lighthouse;
import osv.model.players.skills.agility.impl.Shortcuts;
import osv.model.players.skills.agility.impl.WildernessAgility;
import osv.model.players.skills.agility.impl.rooftop.RooftopArdougne;
import osv.model.players.skills.agility.impl.rooftop.RooftopFalador;
import osv.model.players.skills.agility.impl.rooftop.RooftopSeers;
import osv.model.players.skills.agility.impl.rooftop.RooftopVarrock;
import osv.model.players.skills.crafting.Crafting;
import osv.model.players.skills.farming.Farming;
import osv.model.players.skills.fletching.Fletching;
import osv.model.players.skills.herblore.Herblore;
import osv.model.players.skills.hunter.Hunter;
import osv.model.players.skills.mining.Mining;
import osv.model.players.skills.prayer.Prayer;
import osv.model.players.skills.runecrafting.Runecrafting;
import osv.model.players.skills.slayer.Slayer;
import osv.model.players.skills.thieving.Thieving;
import osv.model.shops.ShopAssistant;
import osv.net.Packet;
import osv.net.Packet.Type;
import osv.net.outgoing.UnnecessaryPacketDropper;
import osv.util.Misc;
import osv.util.SimpleTimer;
import osv.util.Stopwatch;
...
public class Player extends Entity {
	...
	public int raidPoints, unfPotHerb, unfPotAmount, wrenchObject = 0, halloweenOrderNumber = 0, speed1 = -1, speed2 = -1, safeBoxSlots = 15, hostAmount = 3, corpDamage = 0,
			...
			smeltEventId = 5567, waveType, achievementsCompleted, achievementPoints, fireslit, crabsKilled, treesCut, pkp, killcount, deathcount, votePoints, amDonated, level1 = 0,
			...
			face = -1, FocusPointX = -1, FocusPointY = -1, newWalkCmdSteps = 0, tablet = 0;
	private int chatTextColor = 0, chatTextEffects = 0, dragonfireShieldCharge, runEnergy = 100, lastEnergyRecovery, x1 = -1, y1 = -1, x2 = -1, y2 = -1, privateChat, arenaPoints, toxicStaffOfTheDeadCharge, toxicBlowpipeCharge, toxicBlowpipeAmmo, toxicBlowpipeAmmoAmount, serpentineHelmCharge,
			tridentCharge, toxicTridentCharge, runningDistanceTravelled, interfaceOpen;
	...
	public boolean teleportingToDistrict = false, morphed = false, isIdle = false, boneOnAltar = false, dropRateInKills = true, droppingItem = false, acceptAid = false, settingUnnoteAmount = false, settingLootValue = false, didYouKnow = true, yellChannel = true, documentGraphic = false, documentAnimation = false, inProcess = false, isStuck = false, isBusyFollow = false, hasOverloadBoost, needsNewTask = false, keepTitle = false, killTitle = false, hide = false, settingMin, settingMax,
			...
			usingGlory = false, fishing = false, isRunning2 = true, takeAsNote, inCwGame, inCwWait, isNpc, seedPlanted = false, seedWatered = false, patchCleaned = false,
			...
			healthSkill = false, usingChin, infoOn = false, pkDistrict = false;
	...
	public long wogwDonationAmount, lastAuthClaim, totalGorillaDamage, totalGorillaHitsDone, totalMissedGorillaHits, lastImpling, lastWheatPass, lastRoll, lastCloseOfInterface, lastPerformedEmote, lastPickup, lastTeleport, lastMarkDropped, lastObstacleFail, lastForceMovement, lastDropTableSelected, lastDropTableSearch, lastDamageCalculation, lastBankDeposit, buySlayerTimer, buyPestControlTimer, fightCaveLeaveTimer, lastFire, lastMove, bonusXpTime, yellDelay, craftingDelay, lastSmelt = 0,
			...
			lastPlayerMove = System.currentTimeMillis(), lastSpear = System.currentTimeMillis(), lastProtItem = System.currentTimeMillis(), dfsDelay = System.currentTimeMillis(),
			...
			restoreStatsDelay = System.currentTimeMillis(), logoutDelay = System.currentTimeMillis(), buryDelay = System.currentTimeMillis(),
			cleanDelay = System.currentTimeMillis();
	...
	public void highscores() {
		getPA().sendFrame126("Tyras - Top PKers Online", 6399); // Title
		for (int i = 0; i < 10; i++) {
			if (ranks[i] > 0) {
	...
	public void destruct() {
		...
		if (underAttackBy > 0 || underAttackBy2 > 0)
			return;
		if (!rights.isOrInherits(Right.OWNER) && Config.SERVER_STATE == ServerState.PUBLIC_PRIMARY && !inClanWars() && !inClanWarsSafe()) {
			Server.getHighscoresHandler().updateHighscores(this);
		}
	...
	public void loadHighscore() {
		getPA().sendFrame126("Tyras - Top PKers Online", 6399);
	...
	public void checkWellOfGoodwillTimers() {
		...
		if (Wogw.EXPERIENCE_TIMER == 0 && Wogw.PC_POINTS_TIMER == 0 && Wogw.DOUBLE_DROPS_TIMER == 0) {
			sendMessage("@cr10@ <col=6666FF>Wogw is currently NOT active");
		}
		if (Wogw.EXPERIENCE_TIMER > 0) {
			sendMessage("@cr10@ <col=6666FF>Wogw is granting +20% bonus experience for another " + TimeUnit.MILLISECONDS.toMinutes(Wogw.EXPERIENCE_TIMER * 600) + " minutes.");
		}
		if (Wogw.PC_POINTS_TIMER > 0) {
			sendMessage("@cr10@ <col=6666FF>Wogw is granting +5 bonus pc points for another " + TimeUnit.MILLISECONDS.toMinutes(Wogw.PC_POINTS_TIMER * 600) + " minutes.");
		}
		if (Wogw.DOUBLE_DROPS_TIMER > 0) {
			sendMessage("@cr10@ <col=6666FF>Wogw is granting double drops for another " + TimeUnit.MILLISECONDS.toMinutes(Wogw.DOUBLE_DROPS_TIMER * 600) + " minutes.");
		}
	}
	...
	public void initialize() {
		try {
			...
			sendMessage("<img=10><trans=170>Welcome to <col=255>Tyras</col></trans>, " + nameIdentifier + "<col=" + rights.getPrimary().getColor() + ">" + playerName+ "</col>.");
			sendMessage("<img=10><trans=170>Vote for rewards by typing <col=255>::vote</col>. Donate for items by typing <col=255>::store</col>.</trans>");
			sendMessage("<img=10><trans=170>Type the command '::commands' to view all available commands.");
			sendMessage("<img=10><trans=170>Speak to the lumbridge guide for common Q&A.");
			sendMessage("<img=10><trans=170>Please take a moment to register at @blu@::forums@bla@.");
			if (Config.DOUBLE_DROPS && Config.DOUBLE_VOTE_INCENTIVES)
				sendMessage("<img=10>Vote and receive 2x drops and 2x vote rewards.");
...
//			GameItem[] items = new GameItem[playerEquipment.length];
//
//			for (int index = 0; index < playerEquipment.length; index++) {
//				if (playerEquipment[index] < 0) {
//					continue;
//				}
//				items[index] = new GameItem(playerEquipment[index], playerEquipmentN[index]);
//			}
//			equipment = new Equipment(items);
			...
			getPA().sendFrame126("@or1@- PK Points: @whi@" + pkp, 29163);
			getPA().sendFrame126("@or1@- Kills/Deaths: @whi@" + killcount + "@or1@/@whi@" + deathcount, 29164);
			getPA().sendFrame126("@or1@- Current Killstreak: @whi@" + killStreak, 29165);
			getPA().sendFrame126("@or1@- Monster Kill Tracker", 29166);
			
			getPA().sendFrame126("@or1@- Rank: <img=" + (rights.getPrimary().getValue() - 1) + "></img><col=" + rights.getPrimary().getColor() + ">"+ rights.getPrimary().toString().replaceAll("_", " ") + "</col>", 29162);
			//getPA().sendFrame126("@or1@Kills/Deaths: @gre@" + killcount + "@or1@/@gre@" + deathcount, 29164);
			//getPA().sendFrame126("@or1@Hunter KS: @gre@" + getKillstreak().getAmount(Killstreak.Type.HUNTER) + "@or1@, " + "Rogue KS: @gre@" + getKillstreak().getAmount(Killstreak.Type.ROGUE), 29165);
	...
	public void process() {
		...
		if (playTime < Integer.MAX_VALUE) {
			playTime++;
		}

		getPA().sendFrame126("Online: @gre@" + PlayerHandler.getPlayerCount() + "", 29155);
...
//			getPA().walkableInterface(42300);
	...
	public boolean isTargetableBy(NPC npc) {
		return !npc.isDead && Server.npcHandler.isAggressive(npc.getIndex()) && !npc.underAttack && npc.killerId <= 0 && npc.getHeight() == heightLevel;
	}
	...
	public final int[] ARROWS = { 9341, 4160, 11959, 10033, 10034, 882, 883, 884, 885, 886, 887, 888, 889, 890, 891, 892, 893, 4740, 5616, 5617, 5618, 5619, 5620, 5621, 5622, 5623, 5624, 5625,
			5626, 5627, 9139, 9140, 9141, 9142, 9143, 9144, 9145, 9240, 9241, 9242, 9243, 9244, 9245, 9286, 9287, 9288, 9289, 9290, 9291, 9292, 9293, 9294, 9295, 9296, 9297, 9298,
...
//			return;
	...
	/*
	 * public int appendDamage(int damage, Hitmark h) { if (damage < 0) { damage = 0; h = Hitmark.MISS; } if (playerLevel[playerHitpoints] - damage < 0) { damage =
	 * playerLevel[playerHitpoints]; } if (teleTimer <= 0) { playerLevel[playerHitpoints] -= damage; if (!hitUpdateRequired) { hitUpdateRequired = true; hitDiff = damage; hitmark =
	 * h; } else if (!hitUpdateRequired2) { hitUpdateRequired2 = true; hitDiff2 = damage; secondHitmark = h; } this.getPA().refreshSkill(3); } else { if (hitUpdateRequired) {
	 * hitUpdateRequired = false; } if (hitUpdateRequired2) { hitUpdateRequired2 = false; } } updateRequired = true; return damage; }
	 */
