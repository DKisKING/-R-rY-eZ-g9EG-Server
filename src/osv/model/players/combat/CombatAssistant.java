...
import osv.model.players.combat.magic.MagicConfig;
import osv.model.players.combat.magic.MagicExtras;
import osv.model.players.combat.magic.MagicMaxHit;
import osv.model.players.combat.magic.MagicRequirements;
import osv.model.players.combat.melee.CombatPrayer;
import osv.model.players.combat.melee.MeleeData;
import osv.model.players.combat.melee.MeleeExtras;
import osv.model.players.combat.melee.MeleeMaxHit;
import osv.model.players.combat.melee.MeleeRequirements;
import osv.model.players.combat.melee.MeleeSpecial;
import osv.model.players.combat.range.Bow;
import osv.model.players.combat.range.RangeData;
import osv.model.players.combat.range.RangeExtras;
import osv.model.players.combat.range.RangeMaxHit;
...
public class CombatAssistant {
	...
	public boolean usingBolts(int i) {
		return (i >= 9139 && i <= 9145) || (i >= 9236 && i <= 9245) || i >= 9286 && i <= 9306;
	}
